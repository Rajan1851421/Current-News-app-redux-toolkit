...
function WordtoPdf() {
  const [word, setWord] = useState(null);
    ...
    const handlePdfChange = (e) => {
        const selectedWord = e.target.files[0];
  ...
  return (
    <div className='h-screen flex justify-center items-center sm:my-10 md:my-10 xl:my-15 xxl:my-20 '>
            <div className='p-5  w-11/12 md:w-1/2 bg-cyan-400 shadow-lg rounded-md mt-[-150px] '>
                <form action="/upload" method="post" encType="multipart/form-data" className="space-y-4 flex flex-col justify-center items-center mt-3">
                    ...
                    <h2 className="text-2xl font-bold mb-4">Select a Word File</h2>
