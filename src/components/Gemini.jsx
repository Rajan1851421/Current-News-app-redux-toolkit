                    ...
                    {data ? (
                        <div className='flex flex-col justify-center items-center'>
                            ...
                            <div className="w-[75%] bg-[#27272A] rounded-md text-white p-4 h-[400px] overflow-y-auto">
                                {replaceAsterisks(displayedText).split('\n\n').map((paragraph, index) => (
                                    <p key={index} className="mb-4 capitalize">{paragraph}</p>
                                ))}
                            </div>
                        </div>
                    ) : (
                        <div className='w-[90%] mx-auto text-white mt-[-120px]'>
                            ...
                            <p className='text-xl font-bold mt-4'>You can find everything using this AI feature.</p>
                        </div>
                    )}
